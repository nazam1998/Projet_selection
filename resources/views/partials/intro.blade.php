<section class="light-bg">
    <div class="container">
        ...
        <div class="row intro-tables">
            ...
            <div class="col-md-4">
                <div
                    class="{{($item->etat == 'En cours') ? 'intro-blue intro-table-first':'intro-table intro-table-first'}}">
                    
            <h5 class="white heading ">{{$item->formulaire->titre}} <br> {{$item->etat}}</h5>                    
                        ...
                        <div class="item">
                            ...
                            <div class="schedule-row row">
                                ...
                                <div class="col-xs-6 text-right">
                                    <h5 class="white">
                                        {{$etape->date->translatedFormat('j M y',strtotime("7 Janvier 2015"))}}</h5>
                                </div>
                                <p style="margin-top: 40px; font-weight: 15;" class="white heading content">
                                    {{$etape->description}}</p>
                            </div>
