<section id="team" class="section light-bg">
    <div class="container">
        <div class="row title text-center">
            ...
            <h4 class="muted">We're a dream team!</h4>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="team text-center dark-bg">
                    ...
                    <div class="title">
                        <h4 class="light">Ben Adamson</h4>
                        <h5 class="muted regular">Fitness Instructor</h5>
                    </div>
                    <button class="btn btn-blue-fill">Sign Up Now</button>
                </div>
            </div>
            <div class="col-md-4">
                <div class="team text-center dark-bg">
                    ...
                    <div class="title">
                        <h4 class="light">Eva Williams</h4>
                        <h5 class="muted regular">Personal Trainer</h5>
                    </div>
                    <a href="#" class="btn btn-blue-fill ripple">Sign Up Now</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="team text-center dark-bg">
                    ...
                    <div class="title">
                        <h4 class="light">John Phillips</h4>
                        <h5 class="muted regular">Personal Trainer</h5>
                    </div>
                    <a href="#" class="btn btn-blue-fill ripple">Sign Up Now</a>
                </div>
