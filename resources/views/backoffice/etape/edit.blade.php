    ...
    <form class="form-horizontal" action="{{route('etape.update',$etape)}}" method="POST">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                value="@if($errors->first('titre')){{$etape->titre}}@else{{old('titre',$etape->titre)}}@endif" id="inputEmail3"
            ...
            <div class="form-group row">
                ...
                placeholder="Veuillez saisir la description de l'évènement">@if($errors->first('description')){{$etape->description}}@else{{old('description',$etape->description)}}@endif</textarea>
                </div>
            </div>
