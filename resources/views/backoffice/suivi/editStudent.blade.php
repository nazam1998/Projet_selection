...
<div class="card card-info">
  <div class="card-header">
    <h3 class="card-title">Formulaire d'edit du student</h3>
  </div>
  <!-- /.card-header -->
  <!-- form start -->
  <form class="form-horizontal" action="{{route('student.update',$user)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="card-body">
...
<div class="row">
    ...
    @enderror
        ...
        <div class="col-lg-6">
            ...
            <div class='form-group'>
                ...
                <input @if($user->genre=='Homme')checked @endif style="margin-right: 8px;" name="genre" type="radio" value="Homme">
    ...
    <div class="card-footer">
        <button type="submit" class="btn btn-info">Editez le student</button>
    </div>
    <!-- /.card-footer -->
</form>
</div>
