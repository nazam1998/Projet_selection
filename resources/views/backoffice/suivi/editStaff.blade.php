...
<div class="card card-info">
  <div class="card-header">
    <h3 class="card-title">Formulaire d'edit du staff</h3>
  </div>
  <!-- /.card-header -->
  <!-- form start -->
  <form class="form-horizontal" action="{{route('staff.update',$user)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="card-body">
...
<div class="row">
    ...
    <div class="card-footer">
        <button type="submit" class="btn btn-info">Editez le staff</button>
    </div>
    <!-- /.card-footer -->
</form>
</div>
