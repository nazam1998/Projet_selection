...
__webpack_require__(/*! ./jquery-1.11.1.min.js */ "./resources/js/jquery-1.11.1.min.js");
...
__webpack_require__(/*! ./jquery.onepagenav.js */ "./resources/js/jquery.onepagenav.js");
...
window.$ = jQuery = __webpack_require__(/*! ./jquery-1.11.1.min.js */ "./resources/js/jquery-1.11.1.min.js");
...
/***/ "./resources/js/jquery.onepagenav.js":
/*!*******************************************!*\
  !*** ./resources/js/jquery.onepagenav.js ***!
  \*******************************************/
/*! no static exports found */
...
jQuery(function ($) {
  ...
  $(window).load(function () {
    ...
    $('section .cut').each(function () {
      if ($(this).hasClass('cut-top')) $(this).css('border-right-width', $(this).parent().width() + "px");else if ($(this).hasClass('cut-bottom')) $(this).css('border-left-width', $(this).parent().width() + "px");
    }); // Sliders Init
    ...
    $('nav.navbar-fixed-top .navbar-brand img').attr('src', $('nav.navbar-fixed-top .navbar-brand img').data("active-url")); // Typing Intro Init
  ...
  window.addEventListener('scroll', onScroll, false); // Window Resize
  ...
  function centerModal() {
    ...
    var $dialog = $(this).find(".modal-dialog"),
        ...
        bottomMargin = parseInt($dialog.css('marginBottom'), 10); // Make sure you don't hide the top part of the modal w/ a negative margin
...
(function ($, w, d, undefined) {
  function typewriter() {
    ...
    function init(element, options) {
      ...
      }, dataSpeed); // self.animation = setInterval(function(){animate_calification()}, 20);
    } // Metodos publicos
...
__webpack_require__(/*! /home/nazam/Bureau/Projet_selection/resources/js/app.js */"./resources/js/app.js");
__webpack_require__(/*! /home/nazam/Bureau/Projet_selection/resources/sass/app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! /home/nazam/Bureau/Projet_selection/resources/sass/admin.scss */"./resources/sass/admin.scss");
